...
Модель с пуллингом через увеличение шага свёртки показала хорошие результаты на тестовой выборке с точностью около 0.886, что говорит о том, что она хорошо усвоила признаки обучающих данных. Однако на обучающей выборке точность 1. Это указывает на то, что модель всё ещё переобучается.
