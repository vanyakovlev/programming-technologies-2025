...
from project.core.milvus_client import MilvusClient
from project.core.document_processor import DocumentProcessor
from project.core.embedder import create_embedding_function
...
def main():
    ...
    if os.path.exists(files_dir):
        ...
        if result['success']:
            ...
            print(
                f"  Вставлено записей: {len(result.get('inserted_ids', []))}")
        else:
    ...
    from project.core.embedder import Embedder
    embedder = Embedder()
