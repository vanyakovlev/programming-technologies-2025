...
class DocumentProcessor:
    ...
    def process_file(
        self, file_path: str, collection_name: str, encoding: str = "utf-8"
    ) -> dict:
        """
        ...
        try:
            ...
            return {"success": False, "error": str(e), "chunks_count": len(chunks)}

    def process_text(self, text: str, collection_name: str) -> dict:
        """
        ...
        try:
            ...
            return {"success": True, "chunks_count": len(chunks), "inserted_ids": ids}
        except Exception as e:
            return {"success": False, "error": str(e), "chunks_count": len(chunks)}
...
if __name__ == "__main__":
    ...
    embedding_func = create_embedding_function(
        model_name="intfloat/multilingual-e5-base", batch_size=32
    )
