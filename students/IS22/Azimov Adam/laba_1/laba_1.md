...
![Системный промт](images/image_1.png)
...
- При `temperature = 0.1` модель выдавала устойчивые и предсказуемые ответы.  
  ![Пример работы модели с низкой температурой](images/image_2.png)

- При стандартном значении `temperature = 1.0` поведение модели оставалось сбалансированным.  
  ![Результат при температуре 1.0](images/image_3.png)
...
![Системный промпт](images/image_4.png)
